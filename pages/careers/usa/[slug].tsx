...
const JobDetails = ({ data }: { data?: IJobDet }) => {
  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto w-11/12 py-">
        <div className="grid md:grid-cols-2 grid-cols-1 gap-8 py-12">
          <div className="bg-primary p-4 rounded-lg divide-y-2 text-white  h-fit md:!sticky md:top-24">
            <div className="p-4">
